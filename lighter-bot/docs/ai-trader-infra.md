...
*/5 * * * * /root/.openclaw/workspace/lighter-bot/ai-trader/healthcheck.sh >> /tmp/ai-trader-health.log 2>&1

# SQLite backup (every 6 hours)
0 */6 * * * cp /root/.openclaw/workspace/lighter-bot/ai-trader/state/trader.db /root/.openclaw/workspace/lighter-bot/ai-trader/state/trader.db.bak

# Daily performance snapshot
0 0 * * * /usr/bin/python3 /root/.openclaw/workspace/lighter-bot/ai-trader/daily_report.py >> /tmp/ai-trader-daily.log 2>&1
```
